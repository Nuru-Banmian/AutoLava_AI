...
class Settings(BaseSettings):
    ...
    agent_investigation_max_tokens: int = Field(default=50_000, ge=1, le=1_000_000)
    agent_investigation_max_cost_eur: float = Field(default=0.50, gt=0, le=100)
    agent_investigation_retry_attempts: int = Field(default=1, ge=0, le=3)
