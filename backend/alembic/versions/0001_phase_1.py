...
Revision ID: f2558fedb4c7
Revises:
Create Date: 2026-07-13 20:04:32.114666
...
def upgrade() -> None:
    ...
    op.create_table(
        "audit_log",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("operation_domain", sa.String(length=30), nullable=False),
        sa.Column("store_id", sa.Integer(), nullable=True),
        sa.Column("record_id", sa.Integer(), nullable=True),
        sa.Column("record_date", sa.Date(), nullable=True),
        sa.Column("operation_type", sa.String(length=20), nullable=False),
        sa.Column("operation_source", sa.String(length=20), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["operator_user_id"], ["users.id"], name=op.f("fk_audit_log_operator_user_id_users")
        ),
        sa.ForeignKeyConstraint(
            ["store_id"], ["stores.id"], name=op.f("fk_audit_log_store_id_stores")
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.CheckConstraint(
            "is_open in ('营业','休息','天气停业')", name=op.f("ck_store_daily_records_open_status")
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        "store_settings",
        sa.Column("store_id", sa.Integer(), nullable=False),
        sa.Column("standard_work_hours", sa.Integer(), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.CheckConstraint(
            "standard_work_hours between 1 and 24", name=op.f("ck_store_settings_work_hours")
        ),
        sa.ForeignKeyConstraint(
            ["store_id"], ["stores.id"], name=op.f("fk_store_settings_store_id_stores")
        ),
        sa.PrimaryKeyConstraint("store_id", name=op.f("pk_store_settings")),
    )
    op.create_table(
        "system_alerts",
        sa.Column("id", sa.Integer(), nullable=False),
