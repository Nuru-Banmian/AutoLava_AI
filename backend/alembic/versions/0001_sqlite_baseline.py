...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["store_id"], ["stores.id"], name=op.f("fk_daily_briefings_store_id_stores")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["store_id"], ["stores.id"], name=op.f("fk_income_categories_store_id_stores")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["store_id"], ["stores.id"], name=op.f("fk_scheduled_task_logs_store_id_stores")
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "is_open in ('营业','休息','提前休息')", name=op.f("ck_store_daily_records_open_status")
        ),
        sa.CheckConstraint(
            "daily_revenue >= 0", name=op.f("ck_store_daily_records_daily_revenue_nonnegative")
        ),
        sa.ForeignKeyConstraint(
            ["created_by"], ["users.id"], name=op.f("fk_store_daily_records_created_by_users")
        ),
        sa.ForeignKeyConstraint(
            ["store_id"], ["stores.id"], name=op.f("fk_store_daily_records_store_id_stores")
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"], ["users.id"], name=op.f("fk_store_daily_records_updated_by_users")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["store_id"],
            ["stores.id"],
            name=op.f("fk_store_members_store_id_stores"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_store_members_user_id_users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["store_id"], ["stores.id"], name=op.f("fk_system_alerts_store_id_stores")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_daily_income_items_category_id_income_categories"),
        ),
        sa.ForeignKeyConstraint(
            ["record_id"],
            ["store_daily_records.id"],
            name=op.f("fk_daily_income_items_record_id_store_daily_records"),
            ondelete="CASCADE",
        ),
        ...
        sa.UniqueConstraint(
            "record_id", "category_id", name=op.f("uq_daily_income_items_record_id")
        ),
    )
    op.create_index(
