...
def test_compose_contains_exactly_api_and_web_with_persistent_sqlite_data() -> None:
    ...
    assert api["environment"] == {
        ...
        "AUTOLAVA_AGENT_INVESTIGATION_MAX_TOOL_CALLS": (
            "${AUTOLAVA_AGENT_INVESTIGATION_MAX_TOOL_CALLS:-8}"
        ),
        "AUTOLAVA_AGENT_INVESTIGATION_TIMEOUT_SECONDS": (
            "${AUTOLAVA_AGENT_INVESTIGATION_TIMEOUT_SECONDS:-90}"
        ),
        "AUTOLAVA_AGENT_INVESTIGATION_MAX_TOKENS": (
            "${AUTOLAVA_AGENT_INVESTIGATION_MAX_TOKENS:-50000}"
        ),
        "AUTOLAVA_AGENT_INVESTIGATION_MAX_COST_EUR": (
            "${AUTOLAVA_AGENT_INVESTIGATION_MAX_COST_EUR:-0.50}"
        ),
        "AUTOLAVA_AGENT_INVESTIGATION_RETRY_ATTEMPTS": (
            "${AUTOLAVA_AGENT_INVESTIGATION_RETRY_ATTEMPTS:-1}"
        ),
