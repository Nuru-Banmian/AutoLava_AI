...
export function ChartPanel({ title, data, kind, xKey, valueKey, children, embedded = false, emptyMessage }: ChartPanelProps) {
  const rows = data ?? [];
