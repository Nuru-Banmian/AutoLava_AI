...
function ControlledSheet() {
  ...
  return <MemoryRouter>
    ...
    <MobileRecordSheet open={open} record={record} canEdit canDelete={false} washCountEnabled timeZone="Europe/Rome" onDelete={vi.fn()} returnFocusTo={trigger} onOpenChange={setOpen} />
  </MemoryRouter>;
}
