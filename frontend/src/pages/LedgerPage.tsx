...
export function LedgerPage() {
  ...
  useEffect(() => setVisibleMonth(date.slice(0, 7)), [date]);
  ...
  const monthRecords = useQuery<DatabaseResponse>({ queryKey: selected && visibleMonth ? ledgerMonthKey(selected.id, visibleMonth) : ["ledgerMonth", "none"], enabled: Boolean(selected && visibleMonth), queryFn: () => {
